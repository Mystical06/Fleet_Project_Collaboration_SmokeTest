...
public class LoginPage extends BasePage {
    ...
    public List<WebElement> Mdropdown;
    ...
    public WebElement methodUpdateBtn;
    ...
    @FindBy(xpath = "//td[@class='string-cell grid-cell grid-body-cell grid-body-cell-Location']")
    public List<WebElement> containResults;
